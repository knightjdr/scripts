...
saint = read.delim('testfiles/Hippo_SAINTexpress.txt', sep="\t", header=T, as.is=T)
...
write.table(rsquared, file="output/regression.txt", quote = FALSE, row.names = F)
